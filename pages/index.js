      ...
      <div className='wrapper'>
        ...
        <div data-aos="fade-in" className='second-section'>
          <div className='first-box'>
            <div className='box' style={{backgroundColor: darkMode ? "#21222D" : "#F8F8F8"}}>
          ...
          <div className='second-boxes'>
            <div className='box-left' style={{backgroundColor: darkMode ? "#21222D" : "#F8F8F8"}}>
              <h1 className='title-box'>0% Management Fees</h1>
              <p>Free of charge, finding your partner in activities is our first priority.</p>
            </div>
            <div className='box-right' style={{backgroundColor: darkMode ? "#21222D" : "#F8F8F8"}}>
